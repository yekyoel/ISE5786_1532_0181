...
public final class Vector extends Point {
     ...
     */
     public Vector scale(double scalar) {
        if (scalar == 0) throw new IllegalArgumentException("scale by zero is not allowed");
    ...
    public double dotProduct(Vector vector) {
        return _xyz._d1() * vector._xyz._d1() +
               _xyz._d2() * vector._xyz._d2() +
    ...
    /**
     * Normalizes this vector, creating a new vector with the same direction but a length of 1.
